...
class Evaluator:
  ...
  def analyse(
    ...
    if scores_per_test:
      ...
      logging.info(f"eval: program generated by model did not run: {model}, {scores_per_test}, island_id: {island_id}, version_generated: {version_generated}, island_version: {island_version}")
